    ...
    def predict(
        ...
        return {
            ...
            "expected_value":
                expected_value,
            "limitations": [
                "Confidence is calibrated using historical backtest performance.",
                "Calibration is heuristic and is not statistically guaranteed.",
                "Small datasets can produce unstable confidence estimates.",
                "Model disagreement can reduce confidence.",
                "Longer forecast horizons increase uncertainty.",
